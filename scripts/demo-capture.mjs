...
await wait(9000);
await frame('home-live', 35);
await glide(560, 'home-feed'); await frame('home-live-feed', 15);
await scroll(0);
await tap('Alerts'); await wait(4000); await scroll(0); await wait(300);
await frame('alerts-live', 25);
await glide(700, 'alerts-down'); await frame('alerts-notices', 15);
await scroll(0);
await tap('Home'); await wait(2500); await scroll(0); await wait(300);
await tap('Simulate EWL fault'); await wait(9000); await scroll(0); await wait(300);
await frame('home-sim', 40);
await glide(420, 'home-sim-down'); await frame('home-sim-card', 25);
await scroll(0); await wait(300);
await tap('Show me the new route'); await wait(10000); await scroll(0); await wait(400);
await frame('plan-why', 30);
await glide(470, 'plan-down'); await frame('plan-stay', 35);
await glide(1000, 'plan-opts-down'); await frame('plan-options', 20);
await tap('take this'); await wait(3500); await scroll(0); await wait(300);
await frame('trip', 35);
...
await wait(3500); await frame('station', 30);
await page.keyboard.press('Escape');
await page.goto(`${base}/alerts`, { waitUntil: 'domcontentloaded' }); await wait(5000); await scroll(0);
await frame('alerts-disruption', 30);
await browser.close();
